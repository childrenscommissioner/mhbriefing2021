...
Since 2019/20, most areas (89 CCGs - 66%) have reduced the percentage of children whose referrals were closed before treatment. Of these, NHS Wolverhampton and NHS Tameside and Glossop saw the biggest decreases – 26 ppts and 20 ppts respectively (see Table 3). Despite the overall improvement, some CCGs that saw large increases in referral closure rates (see Table 4).
