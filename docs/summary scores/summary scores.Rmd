...
<br/>
Creating CCG level summary scores As with last year’s report, to provide an overall indication of how each CCG compares to the rest of England in terms of children’s access to mental health services, we created a summary score for each CCG based on five key indicators of CYPMHS performance. These indicators are:
...
According to these scoring criteria, NHS Shropshire and NHS West Sussex received the lowest overall score of 8 out of 25. It is followed by NHS Crawley CCG and NHS Horsham and Mid Sussex CCG, both of which have a score of 7 (see table 9).
...
**Bottom 20 CCGs with the lowest overall scores in 2020/21.**
